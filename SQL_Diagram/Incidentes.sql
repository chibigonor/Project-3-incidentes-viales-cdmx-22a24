...
CREATE TABLE "Alcaldias" (
    ...
    CONSTRAINT "pk_Alcaldias" PRIMARY KEY (
        "id"
     )
);
...
CREATE TABLE "TipoIncidente" (
    ...
    CONSTRAINT "pk_TipoIncidente" PRIMARY KEY (
        "id"
     )
);
...
CREATE TABLE "CodigoCierre" (
    ...
    "descripcion" VARCHAR(100)   NOT NULL,
    CONSTRAINT "pk_CodigoCierre" PRIMARY KEY (
        "codigo"
     )
);
...
CREATE TABLE "ClasificacionAlarma" (
    "id" SERIAL   NOT NULL,
    "descripcion" VARCHAR(100)   NOT NULL,
    CONSTRAINT "pk_ClasificacionAlarma" PRIMARY KEY (
        "id"
     )
);
...
CREATE TABLE "TipoEntrada" (
    "id" SERIAL   NOT NULL,
    "descripcion" VARCHAR(100)   NOT NULL,
    CONSTRAINT "pk_TipoEntrada" PRIMARY KEY (
        "id"
     )
);
...
ALTER TABLE "Incidentes" ADD CONSTRAINT "fk_Incidentes_tipo_incidente_c4" FOREIGN KEY("tipo_incidente_c4")
REFERENCES "TipoIncidente" ("id");

ALTER TABLE "Incidentes" ADD CONSTRAINT "fk_Incidentes_alcaldia_inicio" FOREIGN KEY("alcaldia_inicio")
...
ALTER TABLE "Incidentes" ADD CONSTRAINT "fk_Incidentes_alcaldia_cierre" FOREIGN KEY("alcaldia_cierre")
REFERENCES "Alcaldias" ("id");
